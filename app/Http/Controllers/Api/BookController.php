...
class BookController extends Controller
{
    ...
    /**
     * DELETE /api/books/{id}  (SESUAI BAB 6.2)
     */
    public function destroy(string $id)
    {
        ...
        // ⚠️ aturan: tidak boleh hapus jika stok > 0
        if ($book->stock > 0) {
            return response()->json([
                'success' => false,
                // 🔥 WAJIB: tampilkan judul buku
                'message' => 'Buku "' . $book->title . '" tidak bisa dihapus karena stok masih ada.',
            ], 422);
        }
